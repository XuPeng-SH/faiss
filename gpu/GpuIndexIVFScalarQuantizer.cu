...
GpuIndexIVFScalarQuantizer::GpuIndexIVFScalarQuantizer(GpuResources* resources,
  ...
  FAISS_THROW_IF_NOT_MSG(!ivfSQConfig_.useFloat16IVFStorage,
...
void
GpuIndexIVFScalarQuantizer::copyFrom(const faiss::IndexIVFScalarQuantizer* index) {
...
void
GpuIndexIVFScalarQuantizer::copyTo(faiss::IndexIVFScalarQuantizer* index) const {
  DeviceScope scope(device_);

  // We must have the indices in order to copy to ourselves
  FAISS_THROW_IF_NOT_MSG(ivfSQConfig_.indicesOptions != INDICES_IVF,
